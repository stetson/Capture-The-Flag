...
exports.test_win_flags = function(test) {
    ...
    test.ok(controller.join_game(game_id, user1.id, user1), "user2 could not join game");
...
exports.test_bounds_tagging = function(test) {
    ...
    user1.latitude = ctf.game_data[game_id].origin.latitude + HALF_FIELD;
    user1.longitude = ctf.game_data[game_id].origin.longitude;
    user2.latitude = ctf.game_data[game_id].origin.latitude - HALF_FIELD;
